...
void Railways::UnitTestRailways() {
    ...
    if(!found) {
        cout << "VALID STATION IN RAILWAYS : FAILED" <<"\n";
    }
    else{
        cout << "VALID STATION IN RAILWAYS : PASSED" <<"\n";
    }
    ...
    if(!found) {
        cout << "INVALID STATION IN RAILWAYS (NEGATIVE TEST) : PASSED" <<"\n";
    }
    else{
        cout << "INVALID STATION IN RAILWAYS (NEGATIVE TEST) : FAILED" <<"\n";
    }
    ...
    if(Railways::IndianRailways().GetDistance(s1 , s2) != 1447) {      
        cout << "DISTANCE BETWEEN STATION IN RAILWAYS : FAILED" <<"\n";
    }
    else{
        cout << "DISTANCE BETWEEN STATION IN RAILWAYS : PASSED" <<"\n";
    }
